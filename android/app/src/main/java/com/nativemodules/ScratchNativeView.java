...
import com.nativemodules.utils.BitmapUtils;


public class ScratchNativeView extends AppCompatImageView {
    ...
    public ScratchNativeView(Context context) {
        super(context);
        init();
    }

//    public ScratchNativeView(Context context, AttributeSet set) {
//        super(context, set);
//        init();
//    }
//
//    public ScratchNativeView(Context context, AttributeSet attrs, int defStyleAttr) {
...
//    }
    ...
    public void setScratchBitmap(Bitmap cover){
        mDrawable = new BitmapDrawable(getResources(), cover);
...
//
//        Rect rect = new Rect(0, 0, mScratchBitmap.getWidth(), mScratchBitmap.getHeight());
//        if(mDrawable != null) mDrawable.setBounds(rect);
//
//        int startGradientColor = ContextCompat.getColor(getContext(), R.color.scratch_start_gradient);
//        int endGradientColor = ContextCompat.getColor(getContext(), R.color.scratch_end_gradient);
//
...
//
//        mCanvas.drawRect(rect, mGradientBgPaint);
//        if(mDrawable != null) mDrawable.draw(mCanvas);
    }
                ...
                public void onPostExecute(Float percentRevealed) {
                    ...
                    if( ! isRevealed()) {
                        ...
                        if(oldValue != percentRevealed) {
                            mRevealListener.onRevealPercentChangedListener(ScratchNativeView.this, percentRevealed);
                        }

                        // if now revealed.
                        if( isRevealed()) {
                            mRevealListener.onRevealed(ScratchNativeView.this);
                        }
                    }
                }
